...
**enabled** | **Boolean** | If true, jobs will be automatically run based on this policy, according to its schedule. |  [optional]
...
**password** | **String** | The password for the target cluster.  This field is not readable. |  [optional]
