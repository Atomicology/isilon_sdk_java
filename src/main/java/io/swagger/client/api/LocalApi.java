...
import io.swagger.client.model.ClusterTimeExtendedExtended;
...
public class LocalApi {
    ...
    public com.squareup.okhttp.Call getClusterTimeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/platform/3/local/cluster/time";
     ...
     */
    public ClusterTimeExtendedExtended getClusterTime() throws ApiException {
        ApiResponse<ClusterTimeExtendedExtended> resp = getClusterTimeWithHttpInfo();
        return resp.getData();
    }
     ...
     * 
     * Get the current time on the local node.
     * @return ApiResponse&lt;ClusterTimeExtendedExtended&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ClusterTimeExtendedExtended> getClusterTimeWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getClusterTimeValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<ClusterTimeExtendedExtended>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getClusterTimeAsync(final ApiCallback<ClusterTimeExtendedExtended> callback) throws ApiException {
