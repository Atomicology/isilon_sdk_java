...
public class NodeHardwareNode {
  ...
  public NodeHardwareNode chassis(String chassis) {
  ...
  **/
  ...
  public NodeHardwareNode chassisCode(String chassisCode) {
  ...
  **/
  ...
  public NodeHardwareNode chassisCount(String chassisCount) {
  ...
  **/
  ...
  public NodeHardwareNode chassisDepth(String chassisDepth) {
  ...
  **/
  ...
  public NodeHardwareNode propertyClass(String propertyClass) {
  ...
  **/
  ...
  public NodeHardwareNode codeName(String codeName) {
  ...
  **/
  ...
  public NodeHardwareNode computeType(String computeType) {
  ...
  **/
  ...
  public NodeHardwareNode configurationId(String configurationId) {
  ...
  **/
  ...
  public NodeHardwareNode cpu(String cpu) {
    this.cpu = cpu;
    return this;
  }
  ...
  **/
  ...
  public NodeHardwareNode diskController(String diskController) {
  ...
  **/
  ...
  public NodeHardwareNode diskExpander(String diskExpander) {
  ...
  **/
  ...
  public NodeHardwareNode familyCode(String familyCode) {
  ...
  **/
  ...
  public NodeHardwareNode flashDrive(String flashDrive) {
  ...
  **/
  ...
  public NodeHardwareNode generationCode(String generationCode) {
  ...
  **/
  ...
  public NodeHardwareNode hwgen(String hwgen) {
    this.hwgen = hwgen;
    return this;
  }
  ...
  **/
  ...
  public NodeHardwareNode id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public NodeHardwareNode imbVersion(String imbVersion) {
  ...
  **/
  ...
  public NodeHardwareNode infiniband(String infiniband) {
  ...
  **/
  ...
  public NodeHardwareNode lcdVersion(String lcdVersion) {
  ...
  **/
  ...
  public NodeHardwareNode lnn(Integer lnn) {
    this.lnn = lnn;
    return this;
  }
  ...
  **/
  ...
  public NodeHardwareNode model(String model) {
    this.model = model;
    return this;
  }
  ...
  **/
  ...
  public NodeHardwareNode modelCode(String modelCode) {
  ...
  **/
  ...
  public NodeHardwareNode motherboard(String motherboard) {
  ...
  **/
  ...
  public NodeHardwareNode netInterfaces(String netInterfaces) {
  ...
  **/
  ...
  public NodeHardwareNode nodeSlotId(Integer nodeSlotId) {
  ...
  **/
  ...
  public NodeHardwareNode nvram(String nvram) {
    this.nvram = nvram;
    return this;
  }
  ...
  **/
  ...
  public NodeHardwareNode peerSerialNumber(String peerSerialNumber) {
  ...
  **/
  ...
  public NodeHardwareNode performanceCode(String performanceCode) {
  ...
  **/
  ...
  public NodeHardwareNode powersupplies(List<String> powersupplies) {
    this.powersupplies = powersupplies;
    return this;
  }

  public NodeHardwareNode addPowersuppliesItem(String powersuppliesItem) {
  ...
  **/
  ...
  public NodeHardwareNode processor(String processor) {
  ...
  **/
  ...
  public NodeHardwareNode product(String product) {
  ...
  **/
  ...
  public NodeHardwareNode ram(Integer ram) {
    this.ram = ram;
    return this;
  }
  ...
  **/
  ...
  public NodeHardwareNode serialNumber(String serialNumber) {
  ...
  **/
  ...
  public NodeHardwareNode series(String series) {
    this.series = series;
    return this;
  }
  ...
  **/
  ...
  public NodeHardwareNode sledDriveCount(Integer sledDriveCount) {
  ...
  **/
  ...
  public NodeHardwareNode storageClass(String storageClass) {
  ...
  **/
  ...
  public NodeHardwareNode tier(Integer tier) {
    this.tier = tier;
    return this;
  }
  ...
  **/
  ...
  public NodeHardwareNode topLevelAssemblySerialNumber(String topLevelAssemblySerialNumber) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NodeHardwareNode nodeHardwareNode = (NodeHardwareNode) o;
    return Objects.equals(this.chassis, nodeHardwareNode.chassis) &&
        Objects.equals(this.chassisCode, nodeHardwareNode.chassisCode) &&
        Objects.equals(this.chassisCount, nodeHardwareNode.chassisCount) &&
        Objects.equals(this.chassisDepth, nodeHardwareNode.chassisDepth) &&
        Objects.equals(this.propertyClass, nodeHardwareNode.propertyClass) &&
        Objects.equals(this.codeName, nodeHardwareNode.codeName) &&
        Objects.equals(this.computeType, nodeHardwareNode.computeType) &&
        Objects.equals(this.configurationId, nodeHardwareNode.configurationId) &&
        Objects.equals(this.cpu, nodeHardwareNode.cpu) &&
        Objects.equals(this.diskController, nodeHardwareNode.diskController) &&
        Objects.equals(this.diskExpander, nodeHardwareNode.diskExpander) &&
        Objects.equals(this.familyCode, nodeHardwareNode.familyCode) &&
        Objects.equals(this.flashDrive, nodeHardwareNode.flashDrive) &&
        Objects.equals(this.generationCode, nodeHardwareNode.generationCode) &&
        Objects.equals(this.hwgen, nodeHardwareNode.hwgen) &&
        Objects.equals(this.id, nodeHardwareNode.id) &&
        Objects.equals(this.imbVersion, nodeHardwareNode.imbVersion) &&
        Objects.equals(this.infiniband, nodeHardwareNode.infiniband) &&
        Objects.equals(this.lcdVersion, nodeHardwareNode.lcdVersion) &&
        Objects.equals(this.lnn, nodeHardwareNode.lnn) &&
        Objects.equals(this.model, nodeHardwareNode.model) &&
        Objects.equals(this.modelCode, nodeHardwareNode.modelCode) &&
        Objects.equals(this.motherboard, nodeHardwareNode.motherboard) &&
        Objects.equals(this.netInterfaces, nodeHardwareNode.netInterfaces) &&
        Objects.equals(this.nodeSlotId, nodeHardwareNode.nodeSlotId) &&
        Objects.equals(this.nvram, nodeHardwareNode.nvram) &&
        Objects.equals(this.peerSerialNumber, nodeHardwareNode.peerSerialNumber) &&
        Objects.equals(this.performanceCode, nodeHardwareNode.performanceCode) &&
        Objects.equals(this.powersupplies, nodeHardwareNode.powersupplies) &&
        Objects.equals(this.processor, nodeHardwareNode.processor) &&
        Objects.equals(this.product, nodeHardwareNode.product) &&
        Objects.equals(this.ram, nodeHardwareNode.ram) &&
        Objects.equals(this.serialNumber, nodeHardwareNode.serialNumber) &&
        Objects.equals(this.series, nodeHardwareNode.series) &&
        Objects.equals(this.sledDriveCount, nodeHardwareNode.sledDriveCount) &&
        Objects.equals(this.storageClass, nodeHardwareNode.storageClass) &&
        Objects.equals(this.tier, nodeHardwareNode.tier) &&
        Objects.equals(this.topLevelAssemblySerialNumber, nodeHardwareNode.topLevelAssemblySerialNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(chassis, chassisCode, chassisCount, chassisDepth, propertyClass, codeName, computeType, configurationId, cpu, diskController, diskExpander, familyCode, flashDrive, generationCode, hwgen, id, imbVersion, infiniband, lcdVersion, lnn, model, modelCode, motherboard, netInterfaces, nodeSlotId, nvram, peerSerialNumber, performanceCode, powersupplies, processor, product, ram, serialNumber, series, sledDriveCount, storageClass, tier, topLevelAssemblySerialNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class NodeHardwareNode {\n");
