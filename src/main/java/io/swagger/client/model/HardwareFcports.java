...
import io.swagger.client.model.HardwareFcportsNode;
...
public class HardwareFcports {
  @SerializedName("errors")
  private List<NodeDrivesPurposelistError> errors = null;

  @SerializedName("nodes")
  private List<HardwareFcportsNode> nodes = null;

  @SerializedName("total")
  private Integer total = null;

  public HardwareFcports errors(List<NodeDrivesPurposelistError> errors) {
    this.errors = errors;
    return this;
  }

  public HardwareFcports addErrorsItem(NodeDrivesPurposelistError errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public HardwareFcports nodes(List<HardwareFcportsNode> nodes) {
    this.nodes = nodes;
    return this;
  }

  public HardwareFcports addNodesItem(HardwareFcportsNode nodesItem) {
    if (this.nodes == null) {
      this.nodes = new ArrayList<HardwareFcportsNode>();
    }
  ...
  **/
  ...
  public List<HardwareFcportsNode> getNodes() {
    return nodes;
  }

  public void setNodes(List<HardwareFcportsNode> nodes) {
    this.nodes = nodes;
  }

  public HardwareFcports total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HardwareFcports hardwareFcports = (HardwareFcports) o;
    return Objects.equals(this.errors, hardwareFcports.errors) &&
        Objects.equals(this.nodes, hardwareFcports.nodes) &&
        Objects.equals(this.total, hardwareFcports.total);
  }
  ...
  public String toString() {
    ...
    sb.append("class HardwareFcports {\n");
