...
public class GroupnetSubnetCreateParams {
  ...
  public GroupnetSubnetCreateParams description(String description) {
  ...
  **/
  ...
  public GroupnetSubnetCreateParams dsrAddrs(List<String> dsrAddrs) {
    this.dsrAddrs = dsrAddrs;
    return this;
  }

  public GroupnetSubnetCreateParams addDsrAddrsItem(String dsrAddrsItem) {
  ...
  **/
  ...
  public GroupnetSubnetCreateParams gateway(String gateway) {
  ...
  **/
  ...
  public GroupnetSubnetCreateParams gatewayPriority(Integer gatewayPriority) {
  ...
  **/
  ...
  public GroupnetSubnetCreateParams mtu(Integer mtu) {
    this.mtu = mtu;
    return this;
  }
  ...
  **/
  ...
  public GroupnetSubnetCreateParams name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public GroupnetSubnetCreateParams prefixlen(Integer prefixlen) {
   ...
   * @return prefixlen
  **/
  @ApiModelProperty(required = true, value = "Subnet Prefix Length.")
  ...
  public GroupnetSubnetCreateParams scServiceAddr(String scServiceAddr) {
  ...
  **/
  ...
  public GroupnetSubnetCreateParams scServiceName(String scServiceName) {
  ...
  **/
  ...
  public GroupnetSubnetCreateParams vlanEnabled(Boolean vlanEnabled) {
  ...
  **/
  ...
  public GroupnetSubnetCreateParams vlanId(Integer vlanId) {
    this.vlanId = vlanId;
    return this;
  }
  ...
  **/
  ...
  public GroupnetSubnetCreateParams addrFamily(AddrFamilyEnum addrFamily) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GroupnetSubnetCreateParams groupnetSubnetCreateParams = (GroupnetSubnetCreateParams) o;
    return Objects.equals(this.description, groupnetSubnetCreateParams.description) &&
        Objects.equals(this.dsrAddrs, groupnetSubnetCreateParams.dsrAddrs) &&
        Objects.equals(this.gateway, groupnetSubnetCreateParams.gateway) &&
        Objects.equals(this.gatewayPriority, groupnetSubnetCreateParams.gatewayPriority) &&
        Objects.equals(this.mtu, groupnetSubnetCreateParams.mtu) &&
        Objects.equals(this.name, groupnetSubnetCreateParams.name) &&
        Objects.equals(this.prefixlen, groupnetSubnetCreateParams.prefixlen) &&
        Objects.equals(this.scServiceAddr, groupnetSubnetCreateParams.scServiceAddr) &&
        Objects.equals(this.scServiceName, groupnetSubnetCreateParams.scServiceName) &&
        Objects.equals(this.vlanEnabled, groupnetSubnetCreateParams.vlanEnabled) &&
        Objects.equals(this.vlanId, groupnetSubnetCreateParams.vlanId) &&
        Objects.equals(this.addrFamily, groupnetSubnetCreateParams.addrFamily);
  }

  @Override
  public int hashCode() {
    return Objects.hash(description, dsrAddrs, gateway, gatewayPriority, mtu, name, prefixlen, scServiceAddr, scServiceName, vlanEnabled, vlanId, addrFamily);
  }
  ...
  public String toString() {
    ...
    sb.append("class GroupnetSubnetCreateParams {\n");
