...
import io.swagger.client.model.ClusterVersionNode;
...
public class ClusterVersion {
  ...
  private List<ClusterVersionNode> nodes = null;

  @SerializedName("total")
  private Integer total = null;

  public ClusterVersion errors(List<NodeDrivesPurposelistError> errors) {
    this.errors = errors;
    return this;
  }

  public ClusterVersion addErrorsItem(NodeDrivesPurposelistError errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public ClusterVersion nodes(List<ClusterVersionNode> nodes) {
    this.nodes = nodes;
    return this;
  }

  public ClusterVersion addNodesItem(ClusterVersionNode nodesItem) {
    if (this.nodes == null) {
      this.nodes = new ArrayList<ClusterVersionNode>();
    }
  ...
  **/
  ...
  public List<ClusterVersionNode> getNodes() {
    return nodes;
  }

  public void setNodes(List<ClusterVersionNode> nodes) {
    this.nodes = nodes;
  }

  public ClusterVersion total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.errors, clusterVersion.errors) &&
        Objects.equals(this.nodes, clusterVersion.nodes) &&
        Objects.equals(this.total, clusterVersion.total);
  }
