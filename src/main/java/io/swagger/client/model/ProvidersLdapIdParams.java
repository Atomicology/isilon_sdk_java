 ...
 */
@ApiModel(description = "Specifies the properties for the LDAP authentication provider.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-04-19T15:41:52.549-07:00")
public class ProvidersLdapIdParams {
  ...
  private String bindMechanism = null;
  ...
  private String groupSearchScope = null;
  ...
  private String netgroupSearchScope = null;
  ...
  private String userSearchScope = null;

  public ProvidersLdapIdParams alternateSecurityIdentitiesAttribute(String alternateSecurityIdentitiesAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams authentication(Boolean authentication) {
  ...
  **/
  ...
  public ProvidersLdapIdParams balanceServers(Boolean balanceServers) {
  ...
  **/
  ...
  public ProvidersLdapIdParams baseDn(String baseDn) {
    this.baseDn = baseDn;
    return this;
  }
  ...
  **/
  ...
  public ProvidersLdapIdParams bindDn(String bindDn) {
    this.bindDn = bindDn;
    return this;
  }
  ...
  **/
  ...
  public ProvidersLdapIdParams bindMechanism(String bindMechanism) {
  ...
  **/
  ...
  public ProvidersLdapIdParams bindPassword(String bindPassword) {
   ...
   * @return bindPassword
  **/
  @ApiModelProperty(value = "Specifies the password for the distinguished name for binding to the LDAP server.")
  ...
  public ProvidersLdapIdParams bindTimeout(Integer bindTimeout) {
  ...
  **/
  ...
  public ProvidersLdapIdParams certificateAuthorityFile(String certificateAuthorityFile) {
  ...
  **/
  ...
  public ProvidersLdapIdParams checkOnlineInterval(Integer checkOnlineInterval) {
  ...
  **/
  ...
  public ProvidersLdapIdParams cnAttribute(String cnAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams createHomeDirectory(Boolean createHomeDirectory) {
  ...
  **/
  ...
  public ProvidersLdapIdParams cryptPasswordAttribute(String cryptPasswordAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams emailAttribute(String emailAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams enabled(Boolean enabled) {
  ...
  **/
  ...
  public ProvidersLdapIdParams enumerateGroups(Boolean enumerateGroups) {
  ...
  **/
  ...
  public ProvidersLdapIdParams enumerateUsers(Boolean enumerateUsers) {
  ...
  **/
  ...
  public ProvidersLdapIdParams findableGroups(List<String> findableGroups) {
    this.findableGroups = findableGroups;
    return this;
  }

  public ProvidersLdapIdParams addFindableGroupsItem(String findableGroupsItem) {
  ...
  **/
  ...
  public ProvidersLdapIdParams findableUsers(List<String> findableUsers) {
    this.findableUsers = findableUsers;
    return this;
  }

  public ProvidersLdapIdParams addFindableUsersItem(String findableUsersItem) {
  ...
  **/
  ...
  public ProvidersLdapIdParams gecosAttribute(String gecosAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams gidAttribute(String gidAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams groupBaseDn(String groupBaseDn) {
  ...
  **/
  ...
  public ProvidersLdapIdParams groupDomain(String groupDomain) {
  ...
  **/
  ...
  public ProvidersLdapIdParams groupFilter(String groupFilter) {
  ...
  **/
  ...
  public ProvidersLdapIdParams groupMembersAttribute(String groupMembersAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams groupSearchScope(String groupSearchScope) {
  ...
  **/
  ...
  public ProvidersLdapIdParams homeDirectoryTemplate(String homeDirectoryTemplate) {
  ...
  **/
  ...
  public ProvidersLdapIdParams homedirAttribute(String homedirAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams ignoreTlsErrors(Boolean ignoreTlsErrors) {
  ...
  **/
  ...
  public ProvidersLdapIdParams listableGroups(List<String> listableGroups) {
    this.listableGroups = listableGroups;
    return this;
  }

  public ProvidersLdapIdParams addListableGroupsItem(String listableGroupsItem) {
  ...
  **/
  ...
  public ProvidersLdapIdParams listableUsers(List<String> listableUsers) {
    this.listableUsers = listableUsers;
    return this;
  }

  public ProvidersLdapIdParams addListableUsersItem(String listableUsersItem) {
  ...
  **/
  ...
  public ProvidersLdapIdParams loginShell(String loginShell) {
  ...
  **/
  ...
  public ProvidersLdapIdParams memberOfAttribute(String memberOfAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ProvidersLdapIdParams nameAttribute(String nameAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams netgroupBaseDn(String netgroupBaseDn) {
  ...
  **/
  ...
  public ProvidersLdapIdParams netgroupFilter(String netgroupFilter) {
  ...
  **/
  ...
  public ProvidersLdapIdParams netgroupMembersAttribute(String netgroupMembersAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams netgroupSearchScope(String netgroupSearchScope) {
  ...
  **/
  @ApiModelProperty(value = "Specifies the depth from the base DN to perform LDAP searches.")
  public String getNetgroupSearchScope() {
    return netgroupSearchScope;
  }

  public void setNetgroupSearchScope(String netgroupSearchScope) {
    this.netgroupSearchScope = netgroupSearchScope;
  }

  public ProvidersLdapIdParams netgroupTripleAttribute(String netgroupTripleAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams normalizeGroups(Boolean normalizeGroups) {
  ...
  **/
  ...
  public ProvidersLdapIdParams normalizeUsers(Boolean normalizeUsers) {
  ...
  **/
  ...
  public ProvidersLdapIdParams ntPasswordAttribute(String ntPasswordAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams ntlmSupport(String ntlmSupport) {
  ...
  **/
  ...
  public ProvidersLdapIdParams providerDomain(String providerDomain) {
  ...
  **/
  ...
  public ProvidersLdapIdParams requireSecureConnection(Boolean requireSecureConnection) {
  ...
  **/
  ...
  public ProvidersLdapIdParams restrictFindable(Boolean restrictFindable) {
  ...
  **/
  ...
  public ProvidersLdapIdParams restrictListable(Boolean restrictListable) {
  ...
  **/
  ...
  public ProvidersLdapIdParams searchScope(String searchScope) {
  ...
  **/
  ...
  public ProvidersLdapIdParams searchTimeout(Integer searchTimeout) {
  ...
  **/
  ...
  public ProvidersLdapIdParams serverUris(List<String> serverUris) {
    this.serverUris = serverUris;
    return this;
  }

  public ProvidersLdapIdParams addServerUrisItem(String serverUrisItem) {
  ...
  **/
  ...
  public ProvidersLdapIdParams shadowExpireAttribute(String shadowExpireAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams shadowFlagAttribute(String shadowFlagAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams shadowInactiveAttribute(String shadowInactiveAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams shadowLastChangeAttribute(String shadowLastChangeAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams shadowMaxAttribute(String shadowMaxAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams shadowMinAttribute(String shadowMinAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams shadowUserFilter(String shadowUserFilter) {
  ...
  **/
  ...
  public ProvidersLdapIdParams shadowWarningAttribute(String shadowWarningAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams shellAttribute(String shellAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams template(String template) {
  ...
  **/
  ...
  public ProvidersLdapIdParams uidAttribute(String uidAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams unfindableGroups(List<String> unfindableGroups) {
    this.unfindableGroups = unfindableGroups;
    return this;
  }

  public ProvidersLdapIdParams addUnfindableGroupsItem(String unfindableGroupsItem) {
  ...
  **/
  ...
  public ProvidersLdapIdParams unfindableUsers(List<String> unfindableUsers) {
    this.unfindableUsers = unfindableUsers;
    return this;
  }

  public ProvidersLdapIdParams addUnfindableUsersItem(String unfindableUsersItem) {
  ...
  **/
  ...
  public ProvidersLdapIdParams uniqueGroupMembersAttribute(String uniqueGroupMembersAttribute) {
  ...
  **/
  ...
  public ProvidersLdapIdParams unlistableGroups(List<String> unlistableGroups) {
    this.unlistableGroups = unlistableGroups;
    return this;
  }

  public ProvidersLdapIdParams addUnlistableGroupsItem(String unlistableGroupsItem) {
  ...
  **/
  ...
  public ProvidersLdapIdParams unlistableUsers(List<String> unlistableUsers) {
    this.unlistableUsers = unlistableUsers;
    return this;
  }

  public ProvidersLdapIdParams addUnlistableUsersItem(String unlistableUsersItem) {
  ...
  **/
  ...
  public ProvidersLdapIdParams userBaseDn(String userBaseDn) {
  ...
  **/
  ...
  public ProvidersLdapIdParams userDomain(String userDomain) {
  ...
  **/
  ...
  public ProvidersLdapIdParams userFilter(String userFilter) {
  ...
  **/
  ...
  public ProvidersLdapIdParams userSearchScope(String userSearchScope) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProvidersLdapIdParams providersLdapIdParams = (ProvidersLdapIdParams) o;
    return Objects.equals(this.alternateSecurityIdentitiesAttribute, providersLdapIdParams.alternateSecurityIdentitiesAttribute) &&
        Objects.equals(this.authentication, providersLdapIdParams.authentication) &&
        Objects.equals(this.balanceServers, providersLdapIdParams.balanceServers) &&
        Objects.equals(this.baseDn, providersLdapIdParams.baseDn) &&
        Objects.equals(this.bindDn, providersLdapIdParams.bindDn) &&
        Objects.equals(this.bindMechanism, providersLdapIdParams.bindMechanism) &&
        Objects.equals(this.bindPassword, providersLdapIdParams.bindPassword) &&
        Objects.equals(this.bindTimeout, providersLdapIdParams.bindTimeout) &&
        Objects.equals(this.certificateAuthorityFile, providersLdapIdParams.certificateAuthorityFile) &&
        Objects.equals(this.checkOnlineInterval, providersLdapIdParams.checkOnlineInterval) &&
        Objects.equals(this.cnAttribute, providersLdapIdParams.cnAttribute) &&
        Objects.equals(this.createHomeDirectory, providersLdapIdParams.createHomeDirectory) &&
        Objects.equals(this.cryptPasswordAttribute, providersLdapIdParams.cryptPasswordAttribute) &&
        Objects.equals(this.emailAttribute, providersLdapIdParams.emailAttribute) &&
        Objects.equals(this.enabled, providersLdapIdParams.enabled) &&
        Objects.equals(this.enumerateGroups, providersLdapIdParams.enumerateGroups) &&
        Objects.equals(this.enumerateUsers, providersLdapIdParams.enumerateUsers) &&
        Objects.equals(this.findableGroups, providersLdapIdParams.findableGroups) &&
        Objects.equals(this.findableUsers, providersLdapIdParams.findableUsers) &&
        Objects.equals(this.gecosAttribute, providersLdapIdParams.gecosAttribute) &&
        Objects.equals(this.gidAttribute, providersLdapIdParams.gidAttribute) &&
        Objects.equals(this.groupBaseDn, providersLdapIdParams.groupBaseDn) &&
        Objects.equals(this.groupDomain, providersLdapIdParams.groupDomain) &&
        Objects.equals(this.groupFilter, providersLdapIdParams.groupFilter) &&
        Objects.equals(this.groupMembersAttribute, providersLdapIdParams.groupMembersAttribute) &&
        Objects.equals(this.groupSearchScope, providersLdapIdParams.groupSearchScope) &&
        Objects.equals(this.homeDirectoryTemplate, providersLdapIdParams.homeDirectoryTemplate) &&
        Objects.equals(this.homedirAttribute, providersLdapIdParams.homedirAttribute) &&
        Objects.equals(this.ignoreTlsErrors, providersLdapIdParams.ignoreTlsErrors) &&
        Objects.equals(this.listableGroups, providersLdapIdParams.listableGroups) &&
        Objects.equals(this.listableUsers, providersLdapIdParams.listableUsers) &&
        Objects.equals(this.loginShell, providersLdapIdParams.loginShell) &&
        Objects.equals(this.memberOfAttribute, providersLdapIdParams.memberOfAttribute) &&
        Objects.equals(this.name, providersLdapIdParams.name) &&
        Objects.equals(this.nameAttribute, providersLdapIdParams.nameAttribute) &&
        Objects.equals(this.netgroupBaseDn, providersLdapIdParams.netgroupBaseDn) &&
        Objects.equals(this.netgroupFilter, providersLdapIdParams.netgroupFilter) &&
        Objects.equals(this.netgroupMembersAttribute, providersLdapIdParams.netgroupMembersAttribute) &&
        Objects.equals(this.netgroupSearchScope, providersLdapIdParams.netgroupSearchScope) &&
        Objects.equals(this.netgroupTripleAttribute, providersLdapIdParams.netgroupTripleAttribute) &&
        Objects.equals(this.normalizeGroups, providersLdapIdParams.normalizeGroups) &&
        Objects.equals(this.normalizeUsers, providersLdapIdParams.normalizeUsers) &&
        Objects.equals(this.ntPasswordAttribute, providersLdapIdParams.ntPasswordAttribute) &&
        Objects.equals(this.ntlmSupport, providersLdapIdParams.ntlmSupport) &&
        Objects.equals(this.providerDomain, providersLdapIdParams.providerDomain) &&
        Objects.equals(this.requireSecureConnection, providersLdapIdParams.requireSecureConnection) &&
        Objects.equals(this.restrictFindable, providersLdapIdParams.restrictFindable) &&
        Objects.equals(this.restrictListable, providersLdapIdParams.restrictListable) &&
        Objects.equals(this.searchScope, providersLdapIdParams.searchScope) &&
        Objects.equals(this.searchTimeout, providersLdapIdParams.searchTimeout) &&
        Objects.equals(this.serverUris, providersLdapIdParams.serverUris) &&
        Objects.equals(this.shadowExpireAttribute, providersLdapIdParams.shadowExpireAttribute) &&
        Objects.equals(this.shadowFlagAttribute, providersLdapIdParams.shadowFlagAttribute) &&
        Objects.equals(this.shadowInactiveAttribute, providersLdapIdParams.shadowInactiveAttribute) &&
        Objects.equals(this.shadowLastChangeAttribute, providersLdapIdParams.shadowLastChangeAttribute) &&
        Objects.equals(this.shadowMaxAttribute, providersLdapIdParams.shadowMaxAttribute) &&
        Objects.equals(this.shadowMinAttribute, providersLdapIdParams.shadowMinAttribute) &&
        Objects.equals(this.shadowUserFilter, providersLdapIdParams.shadowUserFilter) &&
        Objects.equals(this.shadowWarningAttribute, providersLdapIdParams.shadowWarningAttribute) &&
        Objects.equals(this.shellAttribute, providersLdapIdParams.shellAttribute) &&
        Objects.equals(this.template, providersLdapIdParams.template) &&
        Objects.equals(this.uidAttribute, providersLdapIdParams.uidAttribute) &&
        Objects.equals(this.unfindableGroups, providersLdapIdParams.unfindableGroups) &&
        Objects.equals(this.unfindableUsers, providersLdapIdParams.unfindableUsers) &&
        Objects.equals(this.uniqueGroupMembersAttribute, providersLdapIdParams.uniqueGroupMembersAttribute) &&
        Objects.equals(this.unlistableGroups, providersLdapIdParams.unlistableGroups) &&
        Objects.equals(this.unlistableUsers, providersLdapIdParams.unlistableUsers) &&
        Objects.equals(this.userBaseDn, providersLdapIdParams.userBaseDn) &&
        Objects.equals(this.userDomain, providersLdapIdParams.userDomain) &&
        Objects.equals(this.userFilter, providersLdapIdParams.userFilter) &&
        Objects.equals(this.userSearchScope, providersLdapIdParams.userSearchScope);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alternateSecurityIdentitiesAttribute, authentication, balanceServers, baseDn, bindDn, bindMechanism, bindPassword, bindTimeout, certificateAuthorityFile, checkOnlineInterval, cnAttribute, createHomeDirectory, cryptPasswordAttribute, emailAttribute, enabled, enumerateGroups, enumerateUsers, findableGroups, findableUsers, gecosAttribute, gidAttribute, groupBaseDn, groupDomain, groupFilter, groupMembersAttribute, groupSearchScope, homeDirectoryTemplate, homedirAttribute, ignoreTlsErrors, listableGroups, listableUsers, loginShell, memberOfAttribute, name, nameAttribute, netgroupBaseDn, netgroupFilter, netgroupMembersAttribute, netgroupSearchScope, netgroupTripleAttribute, normalizeGroups, normalizeUsers, ntPasswordAttribute, ntlmSupport, providerDomain, requireSecureConnection, restrictFindable, restrictListable, searchScope, searchTimeout, serverUris, shadowExpireAttribute, shadowFlagAttribute, shadowInactiveAttribute, shadowLastChangeAttribute, shadowMaxAttribute, shadowMinAttribute, shadowUserFilter, shadowWarningAttribute, shellAttribute, template, uidAttribute, unfindableGroups, unfindableUsers, uniqueGroupMembersAttribute, unlistableGroups, unlistableUsers, userBaseDn, userDomain, userFilter, userSearchScope);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProvidersLdapIdParams {\n");
