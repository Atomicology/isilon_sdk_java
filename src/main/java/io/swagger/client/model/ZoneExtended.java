...
public class ZoneExtended {
  ...
  public ZoneExtended alternateSystemProvider(String alternateSystemProvider) {
  ...
  **/
  ...
  public ZoneExtended authProviders(List<String> authProviders) {
    this.authProviders = authProviders;
    return this;
  }

  public ZoneExtended addAuthProvidersItem(String authProvidersItem) {
  ...
  **/
  ...
  public ZoneExtended cacheEntryExpiry(Integer cacheEntryExpiry) {
  ...
  **/
  ...
  public ZoneExtended createPath(Boolean createPath) {
  ...
  **/
  ...
  public ZoneExtended forceOverlap(Boolean forceOverlap) {
  ...
  **/
  ...
  public ZoneExtended homeDirectoryUmask(Integer homeDirectoryUmask) {
  ...
  **/
  ...
  public ZoneExtended ifsRestricted(List<AuthAccessAccessItemFileGroup> ifsRestricted) {
    this.ifsRestricted = ifsRestricted;
    return this;
  }

  public ZoneExtended addIfsRestrictedItem(AuthAccessAccessItemFileGroup ifsRestrictedItem) {
  ...
  **/
  ...
  public ZoneExtended mapUntrusted(String mapUntrusted) {
  ...
  **/
  ...
  public ZoneExtended name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ZoneExtended negativeCacheEntryExpiry(Integer negativeCacheEntryExpiry) {
  ...
  **/
  ...
  public ZoneExtended netbiosName(String netbiosName) {
  ...
  **/
  ...
  public ZoneExtended path(String path) {
    this.path = path;
    return this;
  }
  ...
  **/
  ...
  public ZoneExtended skeletonDirectory(String skeletonDirectory) {
  ...
  **/
  ...
  public ZoneExtended systemProvider(String systemProvider) {
  ...
  **/
  ...
  public ZoneExtended userMappingRules(List<String> userMappingRules) {
    this.userMappingRules = userMappingRules;
    return this;
  }

  public ZoneExtended addUserMappingRulesItem(String userMappingRulesItem) {
  ...
  **/
  ...
  public ZoneExtended groupnet(String groupnet) {
  ...
  **/
  ...
  public ZoneExtended id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public ZoneExtended system(Boolean system) {
    this.system = system;
    return this;
  }
  ...
  **/
  ...
  public ZoneExtended zoneId(Integer zoneId) {
    this.zoneId = zoneId;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ZoneExtended zoneExtended = (ZoneExtended) o;
    return Objects.equals(this.alternateSystemProvider, zoneExtended.alternateSystemProvider) &&
        Objects.equals(this.authProviders, zoneExtended.authProviders) &&
        Objects.equals(this.cacheEntryExpiry, zoneExtended.cacheEntryExpiry) &&
        Objects.equals(this.createPath, zoneExtended.createPath) &&
        Objects.equals(this.forceOverlap, zoneExtended.forceOverlap) &&
        Objects.equals(this.homeDirectoryUmask, zoneExtended.homeDirectoryUmask) &&
        Objects.equals(this.ifsRestricted, zoneExtended.ifsRestricted) &&
        Objects.equals(this.mapUntrusted, zoneExtended.mapUntrusted) &&
        Objects.equals(this.name, zoneExtended.name) &&
        Objects.equals(this.negativeCacheEntryExpiry, zoneExtended.negativeCacheEntryExpiry) &&
        Objects.equals(this.netbiosName, zoneExtended.netbiosName) &&
        Objects.equals(this.path, zoneExtended.path) &&
        Objects.equals(this.skeletonDirectory, zoneExtended.skeletonDirectory) &&
        Objects.equals(this.systemProvider, zoneExtended.systemProvider) &&
        Objects.equals(this.userMappingRules, zoneExtended.userMappingRules) &&
        Objects.equals(this.groupnet, zoneExtended.groupnet) &&
        Objects.equals(this.id, zoneExtended.id) &&
        Objects.equals(this.system, zoneExtended.system) &&
        Objects.equals(this.zoneId, zoneExtended.zoneId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alternateSystemProvider, authProviders, cacheEntryExpiry, createPath, forceOverlap, homeDirectoryUmask, ifsRestricted, mapUntrusted, name, negativeCacheEntryExpiry, netbiosName, path, skeletonDirectory, systemProvider, userMappingRules, groupnet, id, system, zoneId);
  }
