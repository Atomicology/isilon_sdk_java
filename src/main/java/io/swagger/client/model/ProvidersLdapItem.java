...
public class ProvidersLdapItem {
  ...
  private List<String> serverUris = new ArrayList<String>();
  ...
  public ProvidersLdapItem alternateSecurityIdentitiesAttribute(String alternateSecurityIdentitiesAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem authentication(Boolean authentication) {
  ...
  **/
  ...
  public ProvidersLdapItem balanceServers(Boolean balanceServers) {
  ...
  **/
  ...
  public ProvidersLdapItem baseDn(String baseDn) {
    this.baseDn = baseDn;
    return this;
  }
   ...
   * @return baseDn
  **/
  @ApiModelProperty(required = true, value = "Specifies the root of the tree in which to search identities.")
  ...
  public ProvidersLdapItem bindDn(String bindDn) {
    this.bindDn = bindDn;
    return this;
  }
  ...
  **/
  ...
  public ProvidersLdapItem bindMechanism(BindMechanismEnum bindMechanism) {
  ...
  **/
  ...
  public ProvidersLdapItem bindPassword(String bindPassword) {
  ...
  **/
  ...
  public ProvidersLdapItem bindTimeout(Integer bindTimeout) {
  ...
  **/
  ...
  public ProvidersLdapItem certificateAuthorityFile(String certificateAuthorityFile) {
  ...
  **/
  ...
  public ProvidersLdapItem checkOnlineInterval(Integer checkOnlineInterval) {
  ...
  **/
  ...
  public ProvidersLdapItem cnAttribute(String cnAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem createHomeDirectory(Boolean createHomeDirectory) {
  ...
  **/
  ...
  public ProvidersLdapItem cryptPasswordAttribute(String cryptPasswordAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem emailAttribute(String emailAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem enabled(Boolean enabled) {
  ...
  **/
  ...
  public ProvidersLdapItem enumerateGroups(Boolean enumerateGroups) {
  ...
  **/
  ...
  public ProvidersLdapItem enumerateUsers(Boolean enumerateUsers) {
  ...
  **/
  ...
  public ProvidersLdapItem findableGroups(List<String> findableGroups) {
    this.findableGroups = findableGroups;
    return this;
  }

  public ProvidersLdapItem addFindableGroupsItem(String findableGroupsItem) {
  ...
  **/
  ...
  public ProvidersLdapItem findableUsers(List<String> findableUsers) {
    this.findableUsers = findableUsers;
    return this;
  }

  public ProvidersLdapItem addFindableUsersItem(String findableUsersItem) {
  ...
  **/
  ...
  public ProvidersLdapItem gecosAttribute(String gecosAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem gidAttribute(String gidAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem groupBaseDn(String groupBaseDn) {
  ...
  **/
  ...
  public ProvidersLdapItem groupDomain(String groupDomain) {
  ...
  **/
  ...
  public ProvidersLdapItem groupFilter(String groupFilter) {
  ...
  **/
  ...
  public ProvidersLdapItem groupMembersAttribute(String groupMembersAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem groupSearchScope(GroupSearchScopeEnum groupSearchScope) {
  ...
  **/
  ...
  public ProvidersLdapItem groupnet(String groupnet) {
  ...
  **/
  ...
  public ProvidersLdapItem homeDirectoryTemplate(String homeDirectoryTemplate) {
  ...
  **/
  ...
  public ProvidersLdapItem homedirAttribute(String homedirAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem ignoreTlsErrors(Boolean ignoreTlsErrors) {
  ...
  **/
  ...
  public ProvidersLdapItem listableGroups(List<String> listableGroups) {
    this.listableGroups = listableGroups;
    return this;
  }

  public ProvidersLdapItem addListableGroupsItem(String listableGroupsItem) {
  ...
  **/
  ...
  public ProvidersLdapItem listableUsers(List<String> listableUsers) {
    this.listableUsers = listableUsers;
    return this;
  }

  public ProvidersLdapItem addListableUsersItem(String listableUsersItem) {
  ...
  **/
  ...
  public ProvidersLdapItem loginShell(String loginShell) {
  ...
  **/
  ...
  public ProvidersLdapItem memberOfAttribute(String memberOfAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "Specifies the name of the LDAP provider.")
  ...
  public ProvidersLdapItem nameAttribute(String nameAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem netgroupBaseDn(String netgroupBaseDn) {
  ...
  **/
  ...
  public ProvidersLdapItem netgroupFilter(String netgroupFilter) {
  ...
  **/
  ...
  public ProvidersLdapItem netgroupMembersAttribute(String netgroupMembersAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem netgroupSearchScope(NetgroupSearchScopeEnum netgroupSearchScope) {
  ...
  **/
  ...
  public ProvidersLdapItem netgroupTripleAttribute(String netgroupTripleAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem normalizeGroups(Boolean normalizeGroups) {
  ...
  **/
  ...
  public ProvidersLdapItem normalizeUsers(Boolean normalizeUsers) {
  ...
  **/
  ...
  public ProvidersLdapItem ntPasswordAttribute(String ntPasswordAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem ntlmSupport(NtlmSupportEnum ntlmSupport) {
  ...
  **/
  ...
  public ProvidersLdapItem providerDomain(String providerDomain) {
  ...
  **/
  ...
  public ProvidersLdapItem requireSecureConnection(Boolean requireSecureConnection) {
  ...
  **/
  ...
  public ProvidersLdapItem restrictFindable(Boolean restrictFindable) {
  ...
  **/
  ...
  public ProvidersLdapItem restrictListable(Boolean restrictListable) {
  ...
  **/
  ...
  public ProvidersLdapItem searchScope(SearchScopeEnum searchScope) {
  ...
  **/
  ...
  public ProvidersLdapItem searchTimeout(Integer searchTimeout) {
  ...
  **/
  ...
  public ProvidersLdapItem serverUris(List<String> serverUris) {
    this.serverUris = serverUris;
    return this;
  }

  public ProvidersLdapItem addServerUrisItem(String serverUrisItem) {
   ...
   * @return serverUris
  **/
  @ApiModelProperty(required = true, value = "Specifies the server URIs.")
  ...
  public ProvidersLdapItem shadowExpireAttribute(String shadowExpireAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem shadowFlagAttribute(String shadowFlagAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem shadowInactiveAttribute(String shadowInactiveAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem shadowLastChangeAttribute(String shadowLastChangeAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem shadowMaxAttribute(String shadowMaxAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem shadowMinAttribute(String shadowMinAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem shadowUserFilter(String shadowUserFilter) {
  ...
  **/
  ...
  public ProvidersLdapItem shadowWarningAttribute(String shadowWarningAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem shellAttribute(String shellAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem template(String template) {
  ...
  **/
  ...
  public ProvidersLdapItem uidAttribute(String uidAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem unfindableGroups(List<String> unfindableGroups) {
    this.unfindableGroups = unfindableGroups;
    return this;
  }

  public ProvidersLdapItem addUnfindableGroupsItem(String unfindableGroupsItem) {
  ...
  **/
  ...
  public ProvidersLdapItem unfindableUsers(List<String> unfindableUsers) {
    this.unfindableUsers = unfindableUsers;
    return this;
  }

  public ProvidersLdapItem addUnfindableUsersItem(String unfindableUsersItem) {
  ...
  **/
  ...
  public ProvidersLdapItem uniqueGroupMembersAttribute(String uniqueGroupMembersAttribute) {
  ...
  **/
  ...
  public ProvidersLdapItem unlistableGroups(List<String> unlistableGroups) {
    this.unlistableGroups = unlistableGroups;
    return this;
  }

  public ProvidersLdapItem addUnlistableGroupsItem(String unlistableGroupsItem) {
  ...
  **/
  ...
  public ProvidersLdapItem unlistableUsers(List<String> unlistableUsers) {
    this.unlistableUsers = unlistableUsers;
    return this;
  }

  public ProvidersLdapItem addUnlistableUsersItem(String unlistableUsersItem) {
  ...
  **/
  ...
  public ProvidersLdapItem userBaseDn(String userBaseDn) {
  ...
  **/
  ...
  public ProvidersLdapItem userDomain(String userDomain) {
  ...
  **/
  ...
  public ProvidersLdapItem userFilter(String userFilter) {
  ...
  **/
  ...
  public ProvidersLdapItem userSearchScope(UserSearchScopeEnum userSearchScope) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProvidersLdapItem providersLdapItem = (ProvidersLdapItem) o;
    return Objects.equals(this.alternateSecurityIdentitiesAttribute, providersLdapItem.alternateSecurityIdentitiesAttribute) &&
        Objects.equals(this.authentication, providersLdapItem.authentication) &&
        Objects.equals(this.balanceServers, providersLdapItem.balanceServers) &&
        Objects.equals(this.baseDn, providersLdapItem.baseDn) &&
        Objects.equals(this.bindDn, providersLdapItem.bindDn) &&
        Objects.equals(this.bindMechanism, providersLdapItem.bindMechanism) &&
        Objects.equals(this.bindPassword, providersLdapItem.bindPassword) &&
        Objects.equals(this.bindTimeout, providersLdapItem.bindTimeout) &&
        Objects.equals(this.certificateAuthorityFile, providersLdapItem.certificateAuthorityFile) &&
        Objects.equals(this.checkOnlineInterval, providersLdapItem.checkOnlineInterval) &&
        Objects.equals(this.cnAttribute, providersLdapItem.cnAttribute) &&
        Objects.equals(this.createHomeDirectory, providersLdapItem.createHomeDirectory) &&
        Objects.equals(this.cryptPasswordAttribute, providersLdapItem.cryptPasswordAttribute) &&
        Objects.equals(this.emailAttribute, providersLdapItem.emailAttribute) &&
        Objects.equals(this.enabled, providersLdapItem.enabled) &&
        Objects.equals(this.enumerateGroups, providersLdapItem.enumerateGroups) &&
        Objects.equals(this.enumerateUsers, providersLdapItem.enumerateUsers) &&
        Objects.equals(this.findableGroups, providersLdapItem.findableGroups) &&
        Objects.equals(this.findableUsers, providersLdapItem.findableUsers) &&
        Objects.equals(this.gecosAttribute, providersLdapItem.gecosAttribute) &&
        Objects.equals(this.gidAttribute, providersLdapItem.gidAttribute) &&
        Objects.equals(this.groupBaseDn, providersLdapItem.groupBaseDn) &&
        Objects.equals(this.groupDomain, providersLdapItem.groupDomain) &&
        Objects.equals(this.groupFilter, providersLdapItem.groupFilter) &&
        Objects.equals(this.groupMembersAttribute, providersLdapItem.groupMembersAttribute) &&
        Objects.equals(this.groupSearchScope, providersLdapItem.groupSearchScope) &&
        Objects.equals(this.groupnet, providersLdapItem.groupnet) &&
        Objects.equals(this.homeDirectoryTemplate, providersLdapItem.homeDirectoryTemplate) &&
        Objects.equals(this.homedirAttribute, providersLdapItem.homedirAttribute) &&
        Objects.equals(this.ignoreTlsErrors, providersLdapItem.ignoreTlsErrors) &&
        Objects.equals(this.listableGroups, providersLdapItem.listableGroups) &&
        Objects.equals(this.listableUsers, providersLdapItem.listableUsers) &&
        Objects.equals(this.loginShell, providersLdapItem.loginShell) &&
        Objects.equals(this.memberOfAttribute, providersLdapItem.memberOfAttribute) &&
        Objects.equals(this.name, providersLdapItem.name) &&
        Objects.equals(this.nameAttribute, providersLdapItem.nameAttribute) &&
        Objects.equals(this.netgroupBaseDn, providersLdapItem.netgroupBaseDn) &&
        Objects.equals(this.netgroupFilter, providersLdapItem.netgroupFilter) &&
        Objects.equals(this.netgroupMembersAttribute, providersLdapItem.netgroupMembersAttribute) &&
        Objects.equals(this.netgroupSearchScope, providersLdapItem.netgroupSearchScope) &&
        Objects.equals(this.netgroupTripleAttribute, providersLdapItem.netgroupTripleAttribute) &&
        Objects.equals(this.normalizeGroups, providersLdapItem.normalizeGroups) &&
        Objects.equals(this.normalizeUsers, providersLdapItem.normalizeUsers) &&
        Objects.equals(this.ntPasswordAttribute, providersLdapItem.ntPasswordAttribute) &&
        Objects.equals(this.ntlmSupport, providersLdapItem.ntlmSupport) &&
        Objects.equals(this.providerDomain, providersLdapItem.providerDomain) &&
        Objects.equals(this.requireSecureConnection, providersLdapItem.requireSecureConnection) &&
        Objects.equals(this.restrictFindable, providersLdapItem.restrictFindable) &&
        Objects.equals(this.restrictListable, providersLdapItem.restrictListable) &&
        Objects.equals(this.searchScope, providersLdapItem.searchScope) &&
        Objects.equals(this.searchTimeout, providersLdapItem.searchTimeout) &&
        Objects.equals(this.serverUris, providersLdapItem.serverUris) &&
        Objects.equals(this.shadowExpireAttribute, providersLdapItem.shadowExpireAttribute) &&
        Objects.equals(this.shadowFlagAttribute, providersLdapItem.shadowFlagAttribute) &&
        Objects.equals(this.shadowInactiveAttribute, providersLdapItem.shadowInactiveAttribute) &&
        Objects.equals(this.shadowLastChangeAttribute, providersLdapItem.shadowLastChangeAttribute) &&
        Objects.equals(this.shadowMaxAttribute, providersLdapItem.shadowMaxAttribute) &&
        Objects.equals(this.shadowMinAttribute, providersLdapItem.shadowMinAttribute) &&
        Objects.equals(this.shadowUserFilter, providersLdapItem.shadowUserFilter) &&
        Objects.equals(this.shadowWarningAttribute, providersLdapItem.shadowWarningAttribute) &&
        Objects.equals(this.shellAttribute, providersLdapItem.shellAttribute) &&
        Objects.equals(this.template, providersLdapItem.template) &&
        Objects.equals(this.uidAttribute, providersLdapItem.uidAttribute) &&
        Objects.equals(this.unfindableGroups, providersLdapItem.unfindableGroups) &&
        Objects.equals(this.unfindableUsers, providersLdapItem.unfindableUsers) &&
        Objects.equals(this.uniqueGroupMembersAttribute, providersLdapItem.uniqueGroupMembersAttribute) &&
        Objects.equals(this.unlistableGroups, providersLdapItem.unlistableGroups) &&
        Objects.equals(this.unlistableUsers, providersLdapItem.unlistableUsers) &&
        Objects.equals(this.userBaseDn, providersLdapItem.userBaseDn) &&
        Objects.equals(this.userDomain, providersLdapItem.userDomain) &&
        Objects.equals(this.userFilter, providersLdapItem.userFilter) &&
        Objects.equals(this.userSearchScope, providersLdapItem.userSearchScope);
  }

  @Override
  public int hashCode() {
    return Objects.hash(alternateSecurityIdentitiesAttribute, authentication, balanceServers, baseDn, bindDn, bindMechanism, bindPassword, bindTimeout, certificateAuthorityFile, checkOnlineInterval, cnAttribute, createHomeDirectory, cryptPasswordAttribute, emailAttribute, enabled, enumerateGroups, enumerateUsers, findableGroups, findableUsers, gecosAttribute, gidAttribute, groupBaseDn, groupDomain, groupFilter, groupMembersAttribute, groupSearchScope, groupnet, homeDirectoryTemplate, homedirAttribute, ignoreTlsErrors, listableGroups, listableUsers, loginShell, memberOfAttribute, name, nameAttribute, netgroupBaseDn, netgroupFilter, netgroupMembersAttribute, netgroupSearchScope, netgroupTripleAttribute, normalizeGroups, normalizeUsers, ntPasswordAttribute, ntlmSupport, providerDomain, requireSecureConnection, restrictFindable, restrictListable, searchScope, searchTimeout, serverUris, shadowExpireAttribute, shadowFlagAttribute, shadowInactiveAttribute, shadowLastChangeAttribute, shadowMaxAttribute, shadowMinAttribute, shadowUserFilter, shadowWarningAttribute, shellAttribute, template, uidAttribute, unfindableGroups, unfindableUsers, uniqueGroupMembersAttribute, unlistableGroups, unlistableUsers, userBaseDn, userDomain, userFilter, userSearchScope);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProvidersLdapItem {\n");
