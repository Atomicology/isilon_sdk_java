...
public class FtpSettingsSettings {
   ...
   */
  @JsonAdapter(AsciiModeEnum.Adapter.class)
  public enum AsciiModeEnum {
    OFF("off"),
    ...
    public static AsciiModeEnum fromValue(String text) {
      for (AsciiModeEnum b : AsciiModeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<AsciiModeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final AsciiModeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public AsciiModeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return AsciiModeEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("ascii_mode")
  private AsciiModeEnum asciiMode = null;
   ...
   */
  @JsonAdapter(ChrootLocalModeEnum.Adapter.class)
  public enum ChrootLocalModeEnum {
    ALL("all"),
    ...
    ChrootLocalModeEnum(String value) {
      this.value = value;
    }
    ...
    public static ChrootLocalModeEnum fromValue(String text) {
      for (ChrootLocalModeEnum b : ChrootLocalModeEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<ChrootLocalModeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ChrootLocalModeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ChrootLocalModeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return ChrootLocalModeEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("chroot_local_mode")
  private ChrootLocalModeEnum chrootLocalMode = null;
   ...
   */
  @JsonAdapter(DirlistNamesEnum.Adapter.class)
  public enum DirlistNamesEnum {
    NUMERIC("numeric"),
    ...
    public static DirlistNamesEnum fromValue(String text) {
      for (DirlistNamesEnum b : DirlistNamesEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<DirlistNamesEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final DirlistNamesEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public DirlistNamesEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return DirlistNamesEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("dirlist_names")
  private DirlistNamesEnum dirlistNames = null;
  ...
  public FtpSettingsSettings acceptTimeout(Integer acceptTimeout) {
  ...
  **/
  ...
  public FtpSettingsSettings allowAnonAccess(Boolean allowAnonAccess) {
  ...
  **/
  ...
  public FtpSettingsSettings allowAnonUpload(Boolean allowAnonUpload) {
  ...
  **/
  ...
  public FtpSettingsSettings allowDirlists(Boolean allowDirlists) {
  ...
  **/
  ...
  public FtpSettingsSettings allowDownloads(Boolean allowDownloads) {
  ...
  **/
  ...
  public FtpSettingsSettings allowLocalAccess(Boolean allowLocalAccess) {
  ...
  **/
  ...
  public FtpSettingsSettings allowWrites(Boolean allowWrites) {
  ...
  **/
  ...
  public FtpSettingsSettings alwaysChdirHomedir(Boolean alwaysChdirHomedir) {
  ...
  **/
  ...
  public FtpSettingsSettings anonChownUsername(String anonChownUsername) {
  ...
  **/
  ...
  public FtpSettingsSettings anonPasswordList(List<String> anonPasswordList) {
    this.anonPasswordList = anonPasswordList;
    return this;
  }

  public FtpSettingsSettings addAnonPasswordListItem(String anonPasswordListItem) {
  ...
  **/
  ...
  public FtpSettingsSettings anonRootPath(String anonRootPath) {
  ...
  **/
  ...
  public FtpSettingsSettings anonUmask(Integer anonUmask) {
  ...
  **/
  ...
  public FtpSettingsSettings asciiMode(AsciiModeEnum asciiMode) {
  ...
  **/
  ...
  public AsciiModeEnum getAsciiMode() {
    return asciiMode;
  }

  public void setAsciiMode(AsciiModeEnum asciiMode) {
    this.asciiMode = asciiMode;
  }

  public FtpSettingsSettings chrootExceptionList(List<String> chrootExceptionList) {
    this.chrootExceptionList = chrootExceptionList;
    return this;
  }

  public FtpSettingsSettings addChrootExceptionListItem(String chrootExceptionListItem) {
  ...
  **/
  ...
  public FtpSettingsSettings chrootLocalMode(ChrootLocalModeEnum chrootLocalMode) {
  ...
  **/
  ...
  public ChrootLocalModeEnum getChrootLocalMode() {
    return chrootLocalMode;
  }

  public void setChrootLocalMode(ChrootLocalModeEnum chrootLocalMode) {
    this.chrootLocalMode = chrootLocalMode;
  }

  public FtpSettingsSettings connectTimeout(Integer connectTimeout) {
  ...
  **/
  ...
  public FtpSettingsSettings dataTimeout(Integer dataTimeout) {
  ...
  **/
  ...
  public FtpSettingsSettings deniedUserList(List<String> deniedUserList) {
    this.deniedUserList = deniedUserList;
    return this;
  }

  public FtpSettingsSettings addDeniedUserListItem(String deniedUserListItem) {
  ...
  **/
  ...
  public FtpSettingsSettings dirlistLocaltime(Boolean dirlistLocaltime) {
  ...
  **/
  ...
  public FtpSettingsSettings dirlistNames(DirlistNamesEnum dirlistNames) {
  ...
  **/
  ...
  public DirlistNamesEnum getDirlistNames() {
    return dirlistNames;
  }

  public void setDirlistNames(DirlistNamesEnum dirlistNames) {
    this.dirlistNames = dirlistNames;
  }

  public FtpSettingsSettings fileCreatePerm(Integer fileCreatePerm) {
  ...
  **/
  ...
  public FtpSettingsSettings limitAnonPasswords(Boolean limitAnonPasswords) {
  ...
  **/
  ...
  public FtpSettingsSettings localRootPath(String localRootPath) {
  ...
  **/
  ...
  public FtpSettingsSettings localUmask(Integer localUmask) {
  ...
  **/
  ...
  public FtpSettingsSettings serverToServer(Boolean serverToServer) {
  ...
  **/
  ...
  public FtpSettingsSettings service(Boolean service) {
  ...
  **/
  ...
  public FtpSettingsSettings sessionSupport(Boolean sessionSupport) {
  ...
  **/
  ...
  public FtpSettingsSettings sessionTimeout(Integer sessionTimeout) {
  ...
  **/
  ...
  public FtpSettingsSettings userConfigDir(String userConfigDir) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    FtpSettingsSettings ftpSettingsSettings = (FtpSettingsSettings) o;
    return Objects.equals(this.acceptTimeout, ftpSettingsSettings.acceptTimeout) &&
        Objects.equals(this.allowAnonAccess, ftpSettingsSettings.allowAnonAccess) &&
        Objects.equals(this.allowAnonUpload, ftpSettingsSettings.allowAnonUpload) &&
        Objects.equals(this.allowDirlists, ftpSettingsSettings.allowDirlists) &&
        Objects.equals(this.allowDownloads, ftpSettingsSettings.allowDownloads) &&
        Objects.equals(this.allowLocalAccess, ftpSettingsSettings.allowLocalAccess) &&
        Objects.equals(this.allowWrites, ftpSettingsSettings.allowWrites) &&
        Objects.equals(this.alwaysChdirHomedir, ftpSettingsSettings.alwaysChdirHomedir) &&
        Objects.equals(this.anonChownUsername, ftpSettingsSettings.anonChownUsername) &&
        Objects.equals(this.anonPasswordList, ftpSettingsSettings.anonPasswordList) &&
        Objects.equals(this.anonRootPath, ftpSettingsSettings.anonRootPath) &&
        Objects.equals(this.anonUmask, ftpSettingsSettings.anonUmask) &&
        Objects.equals(this.asciiMode, ftpSettingsSettings.asciiMode) &&
        Objects.equals(this.chrootExceptionList, ftpSettingsSettings.chrootExceptionList) &&
        Objects.equals(this.chrootLocalMode, ftpSettingsSettings.chrootLocalMode) &&
        Objects.equals(this.connectTimeout, ftpSettingsSettings.connectTimeout) &&
        Objects.equals(this.dataTimeout, ftpSettingsSettings.dataTimeout) &&
        Objects.equals(this.deniedUserList, ftpSettingsSettings.deniedUserList) &&
        Objects.equals(this.dirlistLocaltime, ftpSettingsSettings.dirlistLocaltime) &&
        Objects.equals(this.dirlistNames, ftpSettingsSettings.dirlistNames) &&
        Objects.equals(this.fileCreatePerm, ftpSettingsSettings.fileCreatePerm) &&
        Objects.equals(this.limitAnonPasswords, ftpSettingsSettings.limitAnonPasswords) &&
        Objects.equals(this.localRootPath, ftpSettingsSettings.localRootPath) &&
        Objects.equals(this.localUmask, ftpSettingsSettings.localUmask) &&
        Objects.equals(this.serverToServer, ftpSettingsSettings.serverToServer) &&
        Objects.equals(this.service, ftpSettingsSettings.service) &&
        Objects.equals(this.sessionSupport, ftpSettingsSettings.sessionSupport) &&
        Objects.equals(this.sessionTimeout, ftpSettingsSettings.sessionTimeout) &&
        Objects.equals(this.userConfigDir, ftpSettingsSettings.userConfigDir);
  }
  ...
  public String toString() {
    ...
    sb.append("class FtpSettingsSettings {\n");
