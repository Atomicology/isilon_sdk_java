...
public class EventAlertConditionCreateParams {
  /**
  ...
  public EventAlertConditionCreateParams categories(List<CategoriesEnum> categories) {
    this.categories = categories;
    return this;
  }

  public EventAlertConditionCreateParams addCategoriesItem(CategoriesEnum categoriesItem) {
  ...
  **/
  ...
  public EventAlertConditionCreateParams channels(List<String> channels) {
    this.channels = channels;
    return this;
  }

  public EventAlertConditionCreateParams addChannelsItem(String channelsItem) {
   ...
   * @return channels
  **/
  @ApiModelProperty(required = true, value = "Channels for alert")
  ...
  public EventAlertConditionCreateParams condition(ConditionEnum condition) {
   ...
   * @return condition
  **/
  @ApiModelProperty(required = true, value = "Trigger condition for alert")
  ...
  public EventAlertConditionCreateParams eventgroupIds(List<String> eventgroupIds) {
    this.eventgroupIds = eventgroupIds;
    return this;
  }

  public EventAlertConditionCreateParams addEventgroupIdsItem(String eventgroupIdsItem) {
  ...
  **/
  ...
  public EventAlertConditionCreateParams id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EventAlertConditionCreateParams interval(Integer interval) {
  ...
  **/
  ...
  public EventAlertConditionCreateParams limit(Integer limit) {
    this.limit = limit;
    return this;
  }
  ...
  **/
  ...
  public EventAlertConditionCreateParams name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public EventAlertConditionCreateParams severities(List<SeveritiesEnum> severities) {
    this.severities = severities;
    return this;
  }

  public EventAlertConditionCreateParams addSeveritiesItem(SeveritiesEnum severitiesItem) {
  ...
  **/
  ...
  public EventAlertConditionCreateParams _transient(Integer _transient) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EventAlertConditionCreateParams eventAlertConditionCreateParams = (EventAlertConditionCreateParams) o;
    return Objects.equals(this.categories, eventAlertConditionCreateParams.categories) &&
        Objects.equals(this.channels, eventAlertConditionCreateParams.channels) &&
        Objects.equals(this.condition, eventAlertConditionCreateParams.condition) &&
        Objects.equals(this.eventgroupIds, eventAlertConditionCreateParams.eventgroupIds) &&
        Objects.equals(this.id, eventAlertConditionCreateParams.id) &&
        Objects.equals(this.interval, eventAlertConditionCreateParams.interval) &&
        Objects.equals(this.limit, eventAlertConditionCreateParams.limit) &&
        Objects.equals(this.name, eventAlertConditionCreateParams.name) &&
        Objects.equals(this.severities, eventAlertConditionCreateParams.severities) &&
        Objects.equals(this._transient, eventAlertConditionCreateParams._transient);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventAlertConditionCreateParams {\n");
