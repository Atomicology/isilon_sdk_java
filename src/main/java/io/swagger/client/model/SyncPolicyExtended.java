...
public class SyncPolicyExtended {
  ...
  private List<String> sourceExcludeDirectories = new ArrayList<String>();

  @SerializedName("source_include_directories")
  private List<String> sourceIncludeDirectories = new ArrayList<String>();
  ...
  public SyncPolicyExtended acceleratedFailback(Boolean acceleratedFailback) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If set to true, SyncIQ will perform failback configuration tasks during the next job run, rather than waiting to perform those tasks during the failback process. Performing these tasks ahead of time will increase the speed of failback operations.")
  ...
  public SyncPolicyExtended action(ActionEnum action) {
    this.action = action;
    return this;
  }
   ...
   * @return action
  **/
  @ApiModelProperty(required = true, value = "If 'copy', source files will be copied to the target cluster.  If 'sync', the target directory will be made an image of the source directory:  Files and directories that have been deleted on the source, have been moved within the target directory, or no longer match the selection criteria will be deleted from the target directory.")
  ...
  public SyncPolicyExtended burstMode(Boolean burstMode) {
   ...
   * @return burstMode
  **/
  @ApiModelProperty(required = true, value = "NOTE: This field should not be changed without the help of Isilon support.  Enable/disable UDP-based data transfer.")
  ...
  public SyncPolicyExtended changelist(Boolean changelist) {
   ...
   * @return changelist
  **/
  @ApiModelProperty(required = true, value = "If true, retain previous source snapshot and incremental repstate, both of which are required for changelist creation.")
  ...
  public SyncPolicyExtended checkIntegrity(Boolean checkIntegrity) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If true, the sync target performs cyclic redundancy checks (CRC) on the data as it is received.")
  ...
  public SyncPolicyExtended cloudDeepCopy(CloudDeepCopyEnum cloudDeepCopy) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If set to deny, replicates all CloudPools smartlinks to the target cluster as smartlinks; if the target cluster does not support the smartlinks, the job will fail. If set to force, replicates all smartlinks to the target cluster as regular files. If set to allow, SyncIQ will attempt to replicate smartlinks to the target cluster as smartlinks; if the target cluster does not support the smartlinks, SyncIQ will replicate the smartlinks as regular files.")
  ...
  public SyncPolicyExtended conflicted(Boolean conflicted) {
   ...
   * @return conflicted
  **/
  @ApiModelProperty(required = true, value = "NOTE: This field should not be changed without the help of Isilon support.  If true, the most recent run of this policy encountered an error and this policy will not start any more scheduled jobs until this field is manually set back to 'false'.")
  ...
  public SyncPolicyExtended description(String description) {
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "User-assigned description of this sync policy.")
  ...
  public SyncPolicyExtended disableFileSplit(Boolean disableFileSplit) {
  ...
  **/
  @ApiModelProperty(required = true, value = "NOTE: This field should not be changed without the help of Isilon support.  If true, the 7.2+ file splitting capability will be disabled.")
  ...
  public SyncPolicyExtended disableFofb(Boolean disableFofb) {
   ...
   * @return disableFofb
  **/
  @ApiModelProperty(required = true, value = "NOTE: This field should not be changed without the help of Isilon support.  Enable/disable sync failover/failback.")
  ...
  public SyncPolicyExtended disableStf(Boolean disableStf) {
   ...
   * @return disableStf
  **/
  @ApiModelProperty(required = true, value = "NOTE: This field should not be changed without the help of Isilon support.  Enable/disable the 6.5+ STF based data transfer and uses only treewalk.")
  ...
  public SyncPolicyExtended enabled(Boolean enabled) {
  ...
  **/
  ...
  public SyncPolicyExtended expectedDataloss(Boolean expectedDataloss) {
  ...
  **/
  @ApiModelProperty(required = true, value = "NOTE: This field should not be changed without the help of Isilon support.  Continue sending files even with the corrupted filesystem.")
  ...
  public SyncPolicyExtended fileMatchingPattern(SyncJobPolicyFileMatchingPattern fileMatchingPattern) {
  ...
  **/
  ...
  public SyncPolicyExtended forceInterface(Boolean forceInterface) {
  ...
  **/
  @ApiModelProperty(required = true, value = "NOTE: This field should not be changed without the help of Isilon support.  Determines whether data is sent only through the subnet and pool specified in the \"source_network\" field. This option can be useful if there are multiple interfaces for the given source subnet.  If you enable this option, the net.inet.ip.choose_ifa_by_ipsrc sysctl should be set.")
  ...
  public SyncPolicyExtended hasSyncState(Boolean hasSyncState) {
   ...
   * @return hasSyncState
  **/
  @ApiModelProperty(required = true, value = "This field is false if the policy is in its initial sync state and true otherwise.  Setting this field to false will reset the policy's sync state.")
  ...
  public SyncPolicyExtended id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public SyncPolicyExtended jobDelay(Integer jobDelay) {
  ...
  **/
  ...
  public SyncPolicyExtended lastJobState(String lastJobState) {
   ...
   * @return lastJobState
  **/
  @ApiModelProperty(required = true, value = "This is the state of the most recent job for this policy.")
  ...
  public SyncPolicyExtended lastStarted(Integer lastStarted) {
  ...
  **/
  ...
  public SyncPolicyExtended lastSuccess(Integer lastSuccess) {
  ...
  **/
  ...
  public SyncPolicyExtended logLevel(LogLevelEnum logLevel) {
   ...
   * @return logLevel
  **/
  @ApiModelProperty(required = true, value = "Severity an event must reach before it is logged.")
  ...
  public SyncPolicyExtended logRemovedFiles(Boolean logRemovedFiles) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If true, the system will log any files or directories that are deleted due to a sync.")
  ...
  public SyncPolicyExtended name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public SyncPolicyExtended nextRun(Integer nextRun) {
  ...
  **/
  ...
  public SyncPolicyExtended passwordSet(Boolean passwordSet) {
   ...
   * @return passwordSet
  **/
  @ApiModelProperty(required = true, value = "Indicates if a password is set for accessing the target cluster. Password value is not shown with GET.")
  ...
  public SyncPolicyExtended priority(Integer priority) {
   ...
   * @return priority
  **/
  @ApiModelProperty(required = true, value = "Determines the priority level of a policy. Policies with higher priority will have precedence to run over lower priority policies. Valid range is [0, 1]. Default is 0.")
  ...
  public SyncPolicyExtended reportMaxAge(Integer reportMaxAge) {
   ...
   * @return reportMaxAge
  **/
  @ApiModelProperty(required = true, value = "Length of time (in seconds) a policy report will be stored.")
  ...
  public SyncPolicyExtended reportMaxCount(Integer reportMaxCount) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Maximum number of policy reports that will be stored on the system.")
  ...
  public SyncPolicyExtended restrictTargetNetwork(Boolean restrictTargetNetwork) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If you specify true, and you specify a SmartConnect zone in the \"target_host\" field, replication policies will connect only to nodes in the specified SmartConnect zone.  If you specify false, replication policies are not restricted to specific nodes on the target cluster.")
  ...
  public SyncPolicyExtended rpoAlert(Integer rpoAlert) {
  ...
  **/
  ...
  public SyncPolicyExtended schedule(String schedule) {
  ...
  **/
  ...
  public SyncPolicyExtended skipLookup(Boolean skipLookup) {
   ...
   * @return skipLookup
  **/
  @ApiModelProperty(required = true, value = "Skip DNS lookup of target IPs.")
  ...
  public SyncPolicyExtended skipWhenSourceUnmodified(Boolean skipWhenSourceUnmodified) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If true and --schedule is set to a time/date, the policy will not run if no changes have been made to the contents of the source directory since the last job successfully completed.")
  ...
  public SyncPolicyExtended snapshotSyncExisting(Boolean snapshotSyncExisting) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If true, snapshot-triggered syncs will include snapshots taken before policy creation time (requires --schedule when-snapshot-taken).")
  ...
  public SyncPolicyExtended snapshotSyncPattern(String snapshotSyncPattern) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The naming pattern that a snapshot must match to trigger a sync when the schedule is when-snapshot-taken (default is \"*\").")
  ...
  public SyncPolicyExtended sourceExcludeDirectories(List<String> sourceExcludeDirectories) {
    this.sourceExcludeDirectories = sourceExcludeDirectories;
    return this;
  }

  public SyncPolicyExtended addSourceExcludeDirectoriesItem(String sourceExcludeDirectoriesItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Directories that will be excluded from the sync.  Modifying this field will result in a full synchronization of all data.")
  ...
  public SyncPolicyExtended sourceIncludeDirectories(List<String> sourceIncludeDirectories) {
    this.sourceIncludeDirectories = sourceIncludeDirectories;
    return this;
  }

  public SyncPolicyExtended addSourceIncludeDirectoriesItem(String sourceIncludeDirectoriesItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Directories that will be included in the sync.  Modifying this field will result in a full synchronization of all data.")
  ...
  public SyncPolicyExtended sourceNetwork(SyncPolicySourceNetwork sourceNetwork) {
  ...
  **/
  ...
  public SyncPolicyExtended sourceRootPath(String sourceRootPath) {
  ...
  **/
  ...
  public SyncPolicyExtended sourceSnapshotArchive(Boolean sourceSnapshotArchive) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If true, archival snapshots of the source data will be taken on the source cluster before a sync.")
  ...
  public SyncPolicyExtended sourceSnapshotExpiration(Integer sourceSnapshotExpiration) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The length of time in seconds to keep snapshots on the source cluster.")
  ...
  public SyncPolicyExtended sourceSnapshotPattern(String sourceSnapshotPattern) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The name pattern for snapshots taken on the source cluster before a sync.")
  ...
  public SyncPolicyExtended targetCompareInitialSync(Boolean targetCompareInitialSync) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If true, the target creates diffs against the original sync.")
  ...
  public SyncPolicyExtended targetDetectModifications(Boolean targetDetectModifications) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If true, target cluster will detect if files have been changed on the target by legacy tree walk syncs.")
  ...
  public SyncPolicyExtended targetHost(String targetHost) {
  ...
  **/
  ...
  public SyncPolicyExtended targetPath(String targetPath) {
  ...
  **/
  ...
  public SyncPolicyExtended targetSnapshotAlias(String targetSnapshotAlias) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The alias of the snapshot taken on the target cluster after the sync completes. A value of @DEFAULT will reset this field to the default creation value.")
  ...
  public SyncPolicyExtended targetSnapshotArchive(Boolean targetSnapshotArchive) {
  ...
  **/
  @ApiModelProperty(required = true, value = "If true, archival snapshots of the target data will be taken on the target cluster after successful sync completions.")
  ...
  public SyncPolicyExtended targetSnapshotExpiration(Integer targetSnapshotExpiration) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The length of time in seconds to keep snapshots on the target cluster.")
  ...
  public SyncPolicyExtended targetSnapshotPattern(String targetSnapshotPattern) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The name pattern for snapshots taken on the target cluster after the sync completes.  A value of @DEFAULT will reset this field to the default creation value.")
  ...
  public SyncPolicyExtended workersPerNode(Integer workersPerNode) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The number of worker threads on a node performing a sync.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SyncPolicyExtended syncPolicyExtended = (SyncPolicyExtended) o;
    return Objects.equals(this.acceleratedFailback, syncPolicyExtended.acceleratedFailback) &&
        Objects.equals(this.action, syncPolicyExtended.action) &&
        Objects.equals(this.burstMode, syncPolicyExtended.burstMode) &&
        Objects.equals(this.changelist, syncPolicyExtended.changelist) &&
        Objects.equals(this.checkIntegrity, syncPolicyExtended.checkIntegrity) &&
        Objects.equals(this.cloudDeepCopy, syncPolicyExtended.cloudDeepCopy) &&
        Objects.equals(this.conflicted, syncPolicyExtended.conflicted) &&
        Objects.equals(this.description, syncPolicyExtended.description) &&
        Objects.equals(this.disableFileSplit, syncPolicyExtended.disableFileSplit) &&
        Objects.equals(this.disableFofb, syncPolicyExtended.disableFofb) &&
        Objects.equals(this.disableStf, syncPolicyExtended.disableStf) &&
        Objects.equals(this.enabled, syncPolicyExtended.enabled) &&
        Objects.equals(this.expectedDataloss, syncPolicyExtended.expectedDataloss) &&
        Objects.equals(this.fileMatchingPattern, syncPolicyExtended.fileMatchingPattern) &&
        Objects.equals(this.forceInterface, syncPolicyExtended.forceInterface) &&
        Objects.equals(this.hasSyncState, syncPolicyExtended.hasSyncState) &&
        Objects.equals(this.id, syncPolicyExtended.id) &&
        Objects.equals(this.jobDelay, syncPolicyExtended.jobDelay) &&
        Objects.equals(this.lastJobState, syncPolicyExtended.lastJobState) &&
        Objects.equals(this.lastStarted, syncPolicyExtended.lastStarted) &&
        Objects.equals(this.lastSuccess, syncPolicyExtended.lastSuccess) &&
        Objects.equals(this.logLevel, syncPolicyExtended.logLevel) &&
        Objects.equals(this.logRemovedFiles, syncPolicyExtended.logRemovedFiles) &&
        Objects.equals(this.name, syncPolicyExtended.name) &&
        Objects.equals(this.nextRun, syncPolicyExtended.nextRun) &&
        Objects.equals(this.passwordSet, syncPolicyExtended.passwordSet) &&
        Objects.equals(this.priority, syncPolicyExtended.priority) &&
        Objects.equals(this.reportMaxAge, syncPolicyExtended.reportMaxAge) &&
        Objects.equals(this.reportMaxCount, syncPolicyExtended.reportMaxCount) &&
        Objects.equals(this.restrictTargetNetwork, syncPolicyExtended.restrictTargetNetwork) &&
        Objects.equals(this.rpoAlert, syncPolicyExtended.rpoAlert) &&
        Objects.equals(this.schedule, syncPolicyExtended.schedule) &&
        Objects.equals(this.skipLookup, syncPolicyExtended.skipLookup) &&
        Objects.equals(this.skipWhenSourceUnmodified, syncPolicyExtended.skipWhenSourceUnmodified) &&
        Objects.equals(this.snapshotSyncExisting, syncPolicyExtended.snapshotSyncExisting) &&
        Objects.equals(this.snapshotSyncPattern, syncPolicyExtended.snapshotSyncPattern) &&
        Objects.equals(this.sourceExcludeDirectories, syncPolicyExtended.sourceExcludeDirectories) &&
        Objects.equals(this.sourceIncludeDirectories, syncPolicyExtended.sourceIncludeDirectories) &&
        Objects.equals(this.sourceNetwork, syncPolicyExtended.sourceNetwork) &&
        Objects.equals(this.sourceRootPath, syncPolicyExtended.sourceRootPath) &&
        Objects.equals(this.sourceSnapshotArchive, syncPolicyExtended.sourceSnapshotArchive) &&
        Objects.equals(this.sourceSnapshotExpiration, syncPolicyExtended.sourceSnapshotExpiration) &&
        Objects.equals(this.sourceSnapshotPattern, syncPolicyExtended.sourceSnapshotPattern) &&
        Objects.equals(this.targetCompareInitialSync, syncPolicyExtended.targetCompareInitialSync) &&
        Objects.equals(this.targetDetectModifications, syncPolicyExtended.targetDetectModifications) &&
        Objects.equals(this.targetHost, syncPolicyExtended.targetHost) &&
        Objects.equals(this.targetPath, syncPolicyExtended.targetPath) &&
        Objects.equals(this.targetSnapshotAlias, syncPolicyExtended.targetSnapshotAlias) &&
        Objects.equals(this.targetSnapshotArchive, syncPolicyExtended.targetSnapshotArchive) &&
        Objects.equals(this.targetSnapshotExpiration, syncPolicyExtended.targetSnapshotExpiration) &&
        Objects.equals(this.targetSnapshotPattern, syncPolicyExtended.targetSnapshotPattern) &&
        Objects.equals(this.workersPerNode, syncPolicyExtended.workersPerNode);
  }
  ...
  public String toString() {
    ...
    sb.append("class SyncPolicyExtended {\n");
