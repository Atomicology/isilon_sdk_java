...
public class SubnetsSubnetPoolsPool {
  ...
  private List<SubnetsSubnetPoolIface> ifaces = new ArrayList<SubnetsSubnetPoolIface>();

  @SerializedName("name")
  private String name = null;

  @SerializedName("ranges")
  private List<SubnetsSubnetPoolRange> ranges = new ArrayList<SubnetsSubnetPoolRange>();
  ...
  private List<String> scDnsZoneAliases = new ArrayList<String>();
  ...
  private List<Integer> scSuspendedNodes = new ArrayList<Integer>();

  @SerializedName("sc_ttl")
  private Integer scTtl = null;

  @SerializedName("static_routes")
  private List<SubnetsSubnetPoolStaticRoute> staticRoutes = new ArrayList<SubnetsSubnetPoolStaticRoute>();

  @SerializedName("subnet")
  private String subnet = null;

  public SubnetsSubnetPoolsPool accessZone(String accessZone) {
   ...
   * @return accessZone
  **/
  @ApiModelProperty(required = true, value = "Name of a valid access zone to map IP address pool to the zone.")
  ...
  public SubnetsSubnetPoolsPool addrFamily(AddrFamilyEnum addrFamily) {
   ...
   * @return addrFamily
  **/
  @ApiModelProperty(required = true, value = "IP address format.")
  ...
  public SubnetsSubnetPoolsPool aggregationMode(AggregationModeEnum aggregationMode) {
  ...
  **/
  @ApiModelProperty(required = true, value = "OneFS supports the following NIC aggregation modes.")
  ...
  public SubnetsSubnetPoolsPool allocMethod(AllocMethodEnum allocMethod) {
   ...
   * @return allocMethod
  **/
  @ApiModelProperty(required = true, value = "Specifies how IP address allocation is done among pool members.")
  ...
  public SubnetsSubnetPoolsPool description(String description) {
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "A description of the pool.")
  ...
  public SubnetsSubnetPoolsPool groupnet(String groupnet) {
   ...
   * @return groupnet
  **/
  @ApiModelProperty(required = true, value = "Name of the groupnet this pool belongs to.")
  ...
  public SubnetsSubnetPoolsPool id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "Unique Pool ID.")
  public String getId() {
    return id;
  }
  ...
  public SubnetsSubnetPoolsPool ifaces(List<SubnetsSubnetPoolIface> ifaces) {
    this.ifaces = ifaces;
    return this;
  }

  public SubnetsSubnetPoolsPool addIfacesItem(SubnetsSubnetPoolIface ifacesItem) {
   ...
   * @return ifaces
  **/
  @ApiModelProperty(required = true, value = "List of interface members in this pool.")
  ...
  public SubnetsSubnetPoolsPool name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public SubnetsSubnetPoolsPool ranges(List<SubnetsSubnetPoolRange> ranges) {
    this.ranges = ranges;
    return this;
  }

  public SubnetsSubnetPoolsPool addRangesItem(SubnetsSubnetPoolRange rangesItem) {
   ...
   * @return ranges
  **/
  @ApiModelProperty(required = true, value = "List of IP address ranges in this pool.")
  ...
  public SubnetsSubnetPoolsPool rebalancePolicy(RebalancePolicyEnum rebalancePolicy) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Rebalance policy..")
  ...
  public SubnetsSubnetPoolsPool rules(List<String> rules) {
    this.rules = rules;
    return this;
  }

  public SubnetsSubnetPoolsPool addRulesItem(String rulesItem) {
   ...
   * @return rules
  **/
  @ApiModelProperty(required = true, value = "Names of the rules in this pool.")
  ...
  public SubnetsSubnetPoolsPool scAutoUnsuspendDelay(Integer scAutoUnsuspendDelay) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Time delay in seconds before a node which has been                 automatically unsuspended becomes usable in SmartConnect                responses for pool zones.")
  ...
  public SubnetsSubnetPoolsPool scConnectPolicy(ScConnectPolicyEnum scConnectPolicy) {
  ...
  **/
  @ApiModelProperty(required = true, value = "SmartConnect client connection balancing policy.")
  ...
  public SubnetsSubnetPoolsPool scDnsZone(String scDnsZone) {
   ...
   * @return scDnsZone
  **/
  @ApiModelProperty(required = true, value = "SmartConnect zone name for the pool.")
  ...
  public SubnetsSubnetPoolsPool scDnsZoneAliases(List<String> scDnsZoneAliases) {
    this.scDnsZoneAliases = scDnsZoneAliases;
    return this;
  }

  public SubnetsSubnetPoolsPool addScDnsZoneAliasesItem(String scDnsZoneAliasesItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "List of SmartConnect zone aliases (DNS names) to the pool.")
  ...
  public SubnetsSubnetPoolsPool scFailoverPolicy(ScFailoverPolicyEnum scFailoverPolicy) {
  ...
  **/
  @ApiModelProperty(required = true, value = "SmartConnect IP failover policy.")
  ...
  public SubnetsSubnetPoolsPool scSubnet(String scSubnet) {
   ...
   * @return scSubnet
  **/
  @ApiModelProperty(required = true, value = "Name of SmartConnect service subnet for this pool.")
  ...
  public SubnetsSubnetPoolsPool scSuspendedNodes(List<Integer> scSuspendedNodes) {
    this.scSuspendedNodes = scSuspendedNodes;
    return this;
  }

  public SubnetsSubnetPoolsPool addScSuspendedNodesItem(Integer scSuspendedNodesItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "List of LNNs showing currently suspended nodes in SmartConnect.")
  ...
  public SubnetsSubnetPoolsPool scTtl(Integer scTtl) {
    this.scTtl = scTtl;
    return this;
  }
   ...
   * @return scTtl
  **/
  @ApiModelProperty(required = true, value = "Time to live value for SmartConnect DNS query responses in seconds.")
  ...
  public SubnetsSubnetPoolsPool staticRoutes(List<SubnetsSubnetPoolStaticRoute> staticRoutes) {
    this.staticRoutes = staticRoutes;
    return this;
  }

  public SubnetsSubnetPoolsPool addStaticRoutesItem(SubnetsSubnetPoolStaticRoute staticRoutesItem) {
  ...
  **/
  ...
  public SubnetsSubnetPoolsPool subnet(String subnet) {
    this.subnet = subnet;
    return this;
  }
   ...
   * @return subnet
  **/
  @ApiModelProperty(required = true, value = "The name of the subnet.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SubnetsSubnetPoolsPool subnetsSubnetPoolsPool = (SubnetsSubnetPoolsPool) o;
    return Objects.equals(this.accessZone, subnetsSubnetPoolsPool.accessZone) &&
        Objects.equals(this.addrFamily, subnetsSubnetPoolsPool.addrFamily) &&
        Objects.equals(this.aggregationMode, subnetsSubnetPoolsPool.aggregationMode) &&
        Objects.equals(this.allocMethod, subnetsSubnetPoolsPool.allocMethod) &&
        Objects.equals(this.description, subnetsSubnetPoolsPool.description) &&
        Objects.equals(this.groupnet, subnetsSubnetPoolsPool.groupnet) &&
        Objects.equals(this.id, subnetsSubnetPoolsPool.id) &&
        Objects.equals(this.ifaces, subnetsSubnetPoolsPool.ifaces) &&
        Objects.equals(this.name, subnetsSubnetPoolsPool.name) &&
        Objects.equals(this.ranges, subnetsSubnetPoolsPool.ranges) &&
        Objects.equals(this.rebalancePolicy, subnetsSubnetPoolsPool.rebalancePolicy) &&
        Objects.equals(this.rules, subnetsSubnetPoolsPool.rules) &&
        Objects.equals(this.scAutoUnsuspendDelay, subnetsSubnetPoolsPool.scAutoUnsuspendDelay) &&
        Objects.equals(this.scConnectPolicy, subnetsSubnetPoolsPool.scConnectPolicy) &&
        Objects.equals(this.scDnsZone, subnetsSubnetPoolsPool.scDnsZone) &&
        Objects.equals(this.scDnsZoneAliases, subnetsSubnetPoolsPool.scDnsZoneAliases) &&
        Objects.equals(this.scFailoverPolicy, subnetsSubnetPoolsPool.scFailoverPolicy) &&
        Objects.equals(this.scSubnet, subnetsSubnetPoolsPool.scSubnet) &&
        Objects.equals(this.scSuspendedNodes, subnetsSubnetPoolsPool.scSuspendedNodes) &&
        Objects.equals(this.scTtl, subnetsSubnetPoolsPool.scTtl) &&
        Objects.equals(this.staticRoutes, subnetsSubnetPoolsPool.staticRoutes) &&
        Objects.equals(this.subnet, subnetsSubnetPoolsPool.subnet);
  }
  ...
  public String toString() {
    ...
    sb.append("class SubnetsSubnetPoolsPool {\n");
