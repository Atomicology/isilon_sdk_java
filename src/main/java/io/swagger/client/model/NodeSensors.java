...
import io.swagger.client.model.NodeSensorsNode;
...
public class NodeSensors {
  ...
  private List<NodeSensorsNode> nodes = null;

  @SerializedName("total")
  private Integer total = null;

  public NodeSensors errors(List<NodeDrivesPurposelistError> errors) {
    this.errors = errors;
    return this;
  }

  public NodeSensors addErrorsItem(NodeDrivesPurposelistError errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public NodeSensors nodes(List<NodeSensorsNode> nodes) {
    this.nodes = nodes;
    return this;
  }

  public NodeSensors addNodesItem(NodeSensorsNode nodesItem) {
    if (this.nodes == null) {
      this.nodes = new ArrayList<NodeSensorsNode>();
    }
  ...
  **/
  ...
  public List<NodeSensorsNode> getNodes() {
    return nodes;
  }

  public void setNodes(List<NodeSensorsNode> nodes) {
    this.nodes = nodes;
  }

  public NodeSensors total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NodeSensors nodeSensors = (NodeSensors) o;
    return Objects.equals(this.errors, nodeSensors.errors) &&
        Objects.equals(this.nodes, nodeSensors.nodes) &&
        Objects.equals(this.total, nodeSensors.total);
  }
