...
public class NetworkGroupnetCreateParams {
  ...
  public NetworkGroupnetCreateParams description(String description) {
  ...
  **/
  ...
  public NetworkGroupnetCreateParams dnsCacheEnabled(Boolean dnsCacheEnabled) {
  ...
  **/
  ...
  public NetworkGroupnetCreateParams dnsOptions(List<DnsOptionsEnum> dnsOptions) {
    this.dnsOptions = dnsOptions;
    return this;
  }

  public NetworkGroupnetCreateParams addDnsOptionsItem(DnsOptionsEnum dnsOptionsItem) {
  ...
  **/
  ...
  public NetworkGroupnetCreateParams dnsSearch(List<String> dnsSearch) {
    this.dnsSearch = dnsSearch;
    return this;
  }

  public NetworkGroupnetCreateParams addDnsSearchItem(String dnsSearchItem) {
  ...
  **/
  ...
  public NetworkGroupnetCreateParams dnsServers(List<String> dnsServers) {
    this.dnsServers = dnsServers;
    return this;
  }

  public NetworkGroupnetCreateParams addDnsServersItem(String dnsServersItem) {
  ...
  **/
  ...
  public NetworkGroupnetCreateParams name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of the groupnet.")
  ...
  public NetworkGroupnetCreateParams serverSideDnsSearch(Boolean serverSideDnsSearch) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NetworkGroupnetCreateParams networkGroupnetCreateParams = (NetworkGroupnetCreateParams) o;
    return Objects.equals(this.description, networkGroupnetCreateParams.description) &&
        Objects.equals(this.dnsCacheEnabled, networkGroupnetCreateParams.dnsCacheEnabled) &&
        Objects.equals(this.dnsOptions, networkGroupnetCreateParams.dnsOptions) &&
        Objects.equals(this.dnsSearch, networkGroupnetCreateParams.dnsSearch) &&
        Objects.equals(this.dnsServers, networkGroupnetCreateParams.dnsServers) &&
        Objects.equals(this.name, networkGroupnetCreateParams.name) &&
        Objects.equals(this.serverSideDnsSearch, networkGroupnetCreateParams.serverSideDnsSearch);
  }
  ...
  public String toString() {
    ...
    sb.append("class NetworkGroupnetCreateParams {\n");
