 ...
 */
@ApiModel(description = "Specifies properties for NFS aliases, which are names for physical paths in the file system.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2018-04-18T15:45:33.897-07:00")
public class NfsAlias {
  ...
  public NfsAlias health(String health) {
    this.health = health;
    return this;
  }
  ...
  **/
  ...
  public NfsAlias name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public NfsAlias path(String path) {
    this.path = path;
    return this;
  }
  ...
  **/
  ...
  public NfsAlias zone(String zone) {
    this.zone = zone;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    NfsAlias nfsAlias = (NfsAlias) o;
    return Objects.equals(this.health, nfsAlias.health) &&
        Objects.equals(this.name, nfsAlias.name) &&
        Objects.equals(this.path, nfsAlias.path) &&
        Objects.equals(this.zone, nfsAlias.zone);
  }
