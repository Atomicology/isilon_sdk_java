...
public class HdfsRackExtended {
  ...
  public HdfsRackExtended clientIpRanges(List<String> clientIpRanges) {
    this.clientIpRanges = clientIpRanges;
    return this;
  }

  public HdfsRackExtended addClientIpRangesItem(String clientIpRangesItem) {
  ...
  **/
  ...
  public HdfsRackExtended ipPools(List<String> ipPools) {
    this.ipPools = ipPools;
    return this;
  }

  public HdfsRackExtended addIpPoolsItem(String ipPoolsItem) {
  ...
  **/
  ...
  public HdfsRackExtended name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public HdfsRackExtended id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @ApiModelProperty(value = "The ID of the rack.")
  public String getId() {
    return id;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    HdfsRackExtended hdfsRackExtended = (HdfsRackExtended) o;
    return Objects.equals(this.clientIpRanges, hdfsRackExtended.clientIpRanges) &&
        Objects.equals(this.ipPools, hdfsRackExtended.ipPools) &&
        Objects.equals(this.name, hdfsRackExtended.name) &&
        Objects.equals(this.id, hdfsRackExtended.id);
  }

  @Override
  public int hashCode() {
    return Objects.hash(clientIpRanges, ipPools, name, id);
  }
  ...
  public String toString() {
    ...
    sb.append("class HdfsRackExtended {\n");
