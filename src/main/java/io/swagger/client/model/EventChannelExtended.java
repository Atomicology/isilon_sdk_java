...
public class EventChannelExtended {
  ...
  public EventChannelExtended allowedNodes(List<Integer> allowedNodes) {
    this.allowedNodes = allowedNodes;
    return this;
  }

  public EventChannelExtended addAllowedNodesItem(Integer allowedNodesItem) {
  ...
  **/
  ...
  public EventChannelExtended enabled(Boolean enabled) {
  ...
  **/
  ...
  public EventChannelExtended excludedNodes(List<Integer> excludedNodes) {
    this.excludedNodes = excludedNodes;
    return this;
  }

  public EventChannelExtended addExcludedNodesItem(Integer excludedNodesItem) {
  ...
  **/
  ...
  public EventChannelExtended parameters(EventChannelParameters parameters) {
  ...
  **/
  ...
  public EventChannelExtended system(Boolean system) {
    this.system = system;
    return this;
  }
  ...
  **/
  ...
  public EventChannelExtended type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public EventChannelExtended id(Integer id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public EventChannelExtended name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Channel name,  may not contain /, max length 254.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EventChannelExtended eventChannelExtended = (EventChannelExtended) o;
    return Objects.equals(this.allowedNodes, eventChannelExtended.allowedNodes) &&
        Objects.equals(this.enabled, eventChannelExtended.enabled) &&
        Objects.equals(this.excludedNodes, eventChannelExtended.excludedNodes) &&
        Objects.equals(this.parameters, eventChannelExtended.parameters) &&
        Objects.equals(this.system, eventChannelExtended.system) &&
        Objects.equals(this.type, eventChannelExtended.type) &&
        Objects.equals(this.id, eventChannelExtended.id) &&
        Objects.equals(this.name, eventChannelExtended.name);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventChannelExtended {\n");
